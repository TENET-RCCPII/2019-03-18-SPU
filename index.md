...
venue: "Walter Sisulu University"        # brief name of host site without address (e.g., "Euphoric State University")
address: "3rd Floor, Collaborative Library, East London"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "-33.021167, 27.906361"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "30 January - 01 February, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Bianca Peterson","Katrin Tirok","Kudakwashe Madzima","Tadiwanashe Gutsa","Zolani Sita"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Andiswa Bukula","Kemi Megbowon"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["katrintirok@gmail.com","slubbe@wsu.ac.za","anelda.vdwalt@gmail.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: http://pad.software-carpentry.org/2019-01-30-WSU-EastLondon          # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<p><strong>Registration:</strong> Please complete the online registration form at <a href="https://goo.gl/forms/2oBElBFjkDfWo6To2">https://goo.gl/forms/2oBElBFjkDfWo6To2</a>. Limited space is available. The workshop is free to attend but a R500 no-show fee will be payable by registered participants who does not show up to the workshop without giving the workshop organisers at least 1 week notice.
  </p>
